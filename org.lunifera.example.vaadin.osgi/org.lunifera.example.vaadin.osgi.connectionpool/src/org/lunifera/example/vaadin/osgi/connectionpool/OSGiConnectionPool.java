 ...
 * and com.vaadin.data.util.sqlcontainer.connection.SimpleJDBCConnectionPool (APL)
 */
...
/**
 * A connection pool that uses OSGi JDBC specification to gain access to the
 * datasource. The class is a copy of vaadins SimpleJDBCConnectionPool and enhanced with OSGi stuff.
 */
