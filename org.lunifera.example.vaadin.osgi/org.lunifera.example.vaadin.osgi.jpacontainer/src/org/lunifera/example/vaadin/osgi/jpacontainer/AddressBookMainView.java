...
import org.lunifera.example.vaadin.osgi.jpacontainer.PersonEditor.EditorSavedEvent;
import org.lunifera.example.vaadin.osgi.jpacontainer.PersonEditor.EditorSavedListener;
import org.lunifera.example.vaadin.osgi.jpacontainer.domain.Department;
import org.lunifera.example.vaadin.osgi.jpacontainer.domain.Person;
...
public class AddressBookMainView extends HorizontalSplitPanel implements
	...
	public AddressBookMainView() {
		...
		persons = Activator.getJPAContainerFactory().make(Person.class,
