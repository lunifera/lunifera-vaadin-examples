...
public class Foo implements Serializable {
	...
	/**
	  ...
	  /**
	   * Returns the list of <code>bar</code>s thereby lazy initializing it. For internal use only!
	   * 
	  ...
	  /**
	   * Adds the given bar to this object. <p>
	   * Since the reference is a composition reference, the opposite reference <code>bar#myfoo</code> of the <code>bar</code> will be handled automatically and no further coding is required to keep them in sync.<p>
	   * See {@link bar#setMyfoo(bar)}.
	   * 
	   * @param bar - the property
	   * @throws RuntimeException if instance is <code>disposed</code>
	   * 
	   */
	  ...
	  /**
	   * Removes the given bar from this object. <p>
	   * Since the reference is a cascading reference, the opposite reference (bar.myfoo)
	   * of the bar will be handled automatically and no further coding is required to keep them in sync. 
	   * See {@link bar#setMyfoo(bar)}.
	   * 
	   * @param bar - the property
	   * @throws RuntimeException if instance is <code>disposed</code>
