...
public class Activator implements BundleActivator,
	...
	/**
	 * Returns the render service. Or <code>null</code>.
	 * 
	 * @return
	 */
	public IECViewUIRenderService getRenderService() {
		ServiceReference<IECViewUIRenderService> ref = context
				.getServiceReference(IECViewUIRenderService.class);
		...
		for (Bundle bundle : context.getBundles()) {
			...
			if (bundle.getState() == Bundle.ACTIVE
					&& (name.startsWith("com.vaadin") || name
							.equals("org.lunifera.example.vaadin.ecview"))) {
	...
	public void bundleChanged(BundleEvent event) {
		...
		if (name.startsWith("com.vaadin")
				|| name.equals("org.lunifera.example.vaadin.ecview")) {
